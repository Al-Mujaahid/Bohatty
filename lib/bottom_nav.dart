...
import 'package:bohatty_cooperative_agent/bohatty_cooperative_page.dart';
import 'package:bohatty_cooperative_agent/main.dart';
import 'package:bohatty_cooperative_agent/widget.dart';
...
class _EmailPageState extends State<EmailPage> {
        ...
        body: Column(children: [
          ...
          Center(
            child: Container(
                height: 170,
                width: 170,
                child: Image.asset("assets/images/bohatty_logo.png")),
          ),
          const Expanded(
              child: SizedBox(
            height: 60,
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      _sendWhatsAppMess(
                          phone: '+234 8029997158',
                          message:
                              "Hi there, I'm an *Bohatty Cooperative App* user");
                    },
                    child: Row(
                      children: [
                        const SizedBox(
  ...
  void _launchEmail() async {
    await launch(
        "mailto:info@bohattycoop.com?subject=As a Bohatty Cooperative App user");
  }
}

void _makePhoneCall() async {
  await launch('tel: +234 8029997158');
}

void _smsMessage() async {
  await launch('sms: +234 8029997158');
}
                ...
                child: Card(
                  ...
                  child: Column(
                    children: [
                      const SizedBox(height: 30),
                      Image.asset(
                        "assets/images/bohatty_logo.png",
                        width: 200,
                      ),
